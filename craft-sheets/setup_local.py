...
REPLACEMENTS = {
    '{{PROJECT_ID}}': 'craft-sheets',
    '{{PROJECT_NAME}}': 'Craft Sheets',
    '{{PROJECT_DESCRIPTION}}': 'A small Excel-style spreadsheet with a live formula engine, named sheets, and CSV/Excel import & export',
    '{{PORT}}': frontend_port,
