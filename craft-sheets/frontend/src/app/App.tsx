 ...
 *
 * Bootstraps the ORIGINAL V1 craft-sheets frontend unchanged — same components,
 ...
 * collection ops AND ports the whole formula engine (backend/formula.py →
 * ./services/formula.ts) so the evaluated `values`/`errors` are computed in the
 * browser. CSV/XLSX import & export were already client-side (SheetJS). Look and
