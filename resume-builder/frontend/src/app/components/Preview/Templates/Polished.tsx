...
export const Polished: React.FC = () => {
  ...
  const sidebarKeys = ['mostProudOf', 'education', 'certifications', 'skills', 'myTime', 'philosophy'];
  const mainKeys = ['summary', 'experience', 'projects', 'publications'];

  return (
    <div style={{ display: 'grid', gridTemplateColumns: '260px 1fr', minHeight: '1123px', height: '100%', backgroundColor: '#ffffff' }}>
      ...
      {/* Right Main Content Area (White Background) */}
