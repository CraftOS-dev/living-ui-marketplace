...
export const SingleColumnV2: React.FC = () => {
        ...
        return sectionVisibility.mostProudOf && mostProudOf.length > 0 ? (
          <div key="mostProudOf">
            <h3 style={{ fontSize: '0.9rem', fontWeight: 900, textTransform: 'uppercase', letterSpacing: '0.05em', color: '#0f172a', borderBottom: `2px solid ${accentColor}`, paddingBottom: '4px', marginBottom: '10px' }}>
              Strengths & Core Impact
            </h3>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
              {mostProudOf.map((item, idx) => (
                <div key={item.id} style={{ padding: '10px 14px', borderRadius: '6px', backgroundColor: '#f8fafc', border: '1px solid #e2e8f0', borderLeft: `4px solid ${accentColor}` }}>
                  <div style={{ fontWeight: 800, fontSize: '0.825rem', color: accentColor }}>{idx + 1}. {item.title}</div>
        ...
        return sectionVisibility.projects && projects && projects.length > 0 ? (
          <div key="projects">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
              {projects.map(proj => (
                <div key={proj.id} style={{ padding: '10px 14px', borderRadius: '6px', backgroundColor: '#f8fafc', border: '1px solid #e2e8f0', borderLeft: `4px solid ${accentColor}` }}>
