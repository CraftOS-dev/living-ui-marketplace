    ...
    switch (key) {
      ...
      case 'experience':
        return sectionVisibility.experience && experiences.length > 0 ? (
          <div key="experience">
            <h3 style={{ fontSize: '0.9rem', fontWeight: 900, textTransform: 'uppercase', letterSpacing: '0.05em', color: accentColor, marginBottom: '16px' }}>
              Experience Timeline
            </h3>

            <div style={{ position: 'relative', paddingLeft: '24px', borderLeft: `3px solid ${accentColor}`, marginLeft: '8px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
              {experiences.map(exp => (
                <div key={exp.id} style={{ position: 'relative' }}>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline' }}>
                    ...
                    <span style={{ fontSize: '0.775rem', fontWeight: 700, color: accentColor }}>
                      {exp.startDate} – {exp.endDate}
                    </span>
                  </div>

                  <div style={{ fontSize: '0.825rem', fontWeight: 700, color: '#334155', marginBottom: '4px' }}>
        ...
        return sectionVisibility.projects && projects && projects.length > 0 ? (
          <div key="projects">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
              {projects.map(proj => (
                <div key={proj.id} style={{ padding: '8px 12px', borderRadius: '6px', backgroundColor: '#f8fafc', border: `1px solid #cbd5e1` }}>
