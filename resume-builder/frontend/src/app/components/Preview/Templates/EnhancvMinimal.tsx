...
export const EnhancvMinimal: React.FC = () => {
    ...
    switch (key) {
      case 'summary':
        return sectionVisibility.summary && personal.summary ? (
          <div key="summary">
            <h3 style={{ fontSize: '0.85rem', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.08em', color: accentColor, borderBottom: `2px solid ${accentColor}`, paddingBottom: '3px', marginBottom: '8px' }}>
              Summary
            </h3>
            <p 
      ...
      case 'experience':
        return sectionVisibility.experience && experiences.length > 0 ? (
          <div key="experience">
            <h3 style={{ fontSize: '0.85rem', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.08em', color: accentColor, borderBottom: `2px solid ${accentColor}`, paddingBottom: '3px', marginBottom: '12px' }}>
              Experience
            </h3>
      ...
      case 'education':
        return sectionVisibility.education && educations.length > 0 ? (
          <div key="education">
            ...
            {educations.map(edu => (
              <div key={edu.id} className="resume-section-item" style={{ marginBottom: '8px', fontSize: '0.8rem', breakInside: 'avoid', pageBreakInside: 'avoid' }}>
  ...
  const rightKeys = ['skills', 'myTime', 'certifications', 'mostProudOf', 'philosophy'];
  ...
  return (
    <div style={{ padding: '36px', minHeight: '1123px', color: '#0f172a', backgroundColor: '#ffffff', fontFamily: 'inherit' }}>
      ...
      <div style={{ borderBottom: '1px solid #e2e8f0', paddingBottom: '16px', marginBottom: '24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div>
          <h1 
            style={{ fontSize: '2.5rem', fontWeight: 800, color: '#0f172a', letterSpacing: '-0.01em', lineHeight: 1.1 }}
            contentEditable 
            suppressContentEditableWarning 
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '12px', fontSize: '0.775rem', color: '#64748b', marginTop: '8px', fontWeight: 500 }}>
            {personal.phone && (
              <span>
        ...
        {/* Photo Avatar on Top Right Side */}
