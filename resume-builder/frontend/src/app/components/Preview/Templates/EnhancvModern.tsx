...
export const EnhancvModern: React.FC = () => {
  ...
  const rightKeys = ['skills', 'mostProudOf', 'myTime', 'certifications', 'philosophy'];

  return (
    <div style={{ padding: '36px', minHeight: '1123px', color: '#0f172a', backgroundColor: '#ffffff', fontFamily: 'inherit' }}>
      {/* Header Block */}
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', borderBottom: '2px solid #e2e8f0', paddingBottom: '18px', marginBottom: '24px' }}>
        <div>
          <h1 
