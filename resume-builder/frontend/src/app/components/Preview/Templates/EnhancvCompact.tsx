...
export const EnhancvCompact: React.FC = () => {
  ...
  const leftKeys = ['experience', 'education', 'projects', 'publications'];
  const rightKeys = ['summary', 'mostProudOf', 'skills', 'certifications', 'myTime', 'philosophy'];

  return (
    <div style={{ padding: '36px', minHeight: '1123px', color: '#0f172a', backgroundColor: '#ffffff', fontFamily: 'inherit' }}>
      {/* Header Block */}
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', borderBottom: '2px solid #e2e8f0', paddingBottom: '16px', marginBottom: '24px' }}>
        <div>
          <h1 
            style={{ fontSize: '2.5rem', fontWeight: 900, color: '#0f172a', lineHeight: 1.1 }}
            contentEditable 
            suppressContentEditableWarning 
