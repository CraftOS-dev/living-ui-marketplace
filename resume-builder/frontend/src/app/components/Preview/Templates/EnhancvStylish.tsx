...
export const EnhancvStylish: React.FC = () => {
        ...
        return sectionVisibility.skills && skills.length > 0 ? (
          <div key="skills">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
              {skills.map(sk => (
                <div key={sk.id} style={{ fontSize: '0.8rem', fontWeight: 600, color: '#0f172a', paddingBottom: '3px', borderBottom: '1px dashed #e2e8f0' }}>
                  {sk.name}
                </div>
              ))}
            </div>
  ...
  const leftKeys = ['mostProudOf', 'skills', 'education', 'certifications', 'myTime', 'philosophy', 'publications'];
  ...
  return (
    <div style={{ padding: '40px 36px', minHeight: '1123px', color: '#0f172a', backgroundColor: '#ffffff', fontFamily: 'inherit' }}>
      ...
      {/* 2-Column Grid (Left Sidebar, Right Main) */}
