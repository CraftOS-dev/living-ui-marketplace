...
REPLACEMENTS = {
    '{{PROJECT_ID}}': 'brainstorm-graph',
    '{{PROJECT_NAME}}': 'Brainstorm Graph',
    '{{PROJECT_DESCRIPTION}}': 'Agentic brainstorming tool: give a topic, AI spawns a growing graph of questions and ideas',
    '{{PORT}}': frontend_port,
