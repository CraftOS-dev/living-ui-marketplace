...
// V2: download URLs resolve to the client-side adapter (sentinel host), which a
// real navigation (window.open) can't reach. Fetch the file through the patched
// window.fetch and save it via a temporary <a download>.
