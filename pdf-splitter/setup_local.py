...
REPLACEMENTS = {
    '{{PROJECT_ID}}': 'pdf-splitter',
    '{{PROJECT_NAME}}': 'PDF Splitter',
    '{{PROJECT_DESCRIPTION}}': 'Upload a PDF, preview pages, then split by selected pages, custom ranges, or every N pages. Download individual files or a ZIP.',
    '{{PORT}}': frontend_port,
    '{{BACKEND_PORT}}': backend_port,
    '{{THEME}}': 'system',
    '{{CREATED_AT}}': '2026-05-10T11:21:46',
    '{{FEATURES}}': '',
}
