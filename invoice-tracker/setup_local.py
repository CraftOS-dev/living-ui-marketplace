...
REPLACEMENTS = {
    ...
    '{{PROJECT_NAME}}': 'Invoice & Subscription Tracker',
    '{{PROJECT_DESCRIPTION}}': 'Email-connected living UI that classifies invoices and receipts, tracks recurring subscriptions, calculates burn rate, and provides interactive spending analytics',
    '{{PORT}}': frontend_port,
