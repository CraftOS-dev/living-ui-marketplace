...
export const AddInvoiceModal: React.FC<Props> = ({ isOpen, onClose, onAdd }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onAdd({
      ...
      emailSender: 'manual@entry.local',
      hasPdfAttachment: !!attachedPdf,
      pdfFilename: attachedPdf?.name || (attachedPdf ? 'invoice_receipt.pdf' : undefined),
      pdfTextPreview: attachedPdf?.textPreview,
      pdfDataBase64: attachedPdf?.base64,
    })
