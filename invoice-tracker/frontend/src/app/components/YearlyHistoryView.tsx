...
import type { InvoiceReceipt, Subscription, YearlyHistoryData, YearlySummaryItem } from '../types.ts'
    ...
    return years.map((y) => {
      ...
      yearInvs.forEach((inv) => {
        ...
        if (inv.invoiceDate) {
          ...
          const mKey = mNames[m] || 'Aug'
          monthsMap[mKey] = (monthsMap[mKey] || 0) + inv.amount
