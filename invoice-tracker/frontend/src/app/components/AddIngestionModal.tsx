...
export const AddIngestionModal: React.FC<Props> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (vendor.trim()) eventPayload.vendor = vendor.trim()
      if (parsedAmount !== undefined && !isNaN(parsedAmount)) eventPayload.amount = parsedAmount
      if (description.trim()) eventPayload.description = description.trim()
      if (activeGroupId) eventPayload.group_id = activeGroupId
