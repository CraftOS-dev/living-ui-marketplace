...
To run manually:
    uvicorn main:app --port 3200 --reload
"""
...
app = FastAPI(
    title="Invoice & Subscription Tracker API",
    description="Backend API for Invoice & Subscription Tracker Living UI",
    version="1.0.0",
    lifespan=lifespan,
)
...
async def health_check():
    ...
    return {"status": "healthy", "project": "invoice-tracker"}
