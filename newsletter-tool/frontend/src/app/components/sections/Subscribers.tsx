      ...
      <SectionHeader
        ...
        actions={[
          ...
          <a
            ...
            onClick={async (e) => {
              // The V2 backend is served by PocketBase; the CSV comes back
              // through the API adapter, so fetch it and trigger a client-side
              // download instead of navigating to the (proxied) URL.
              e.preventDefault()
              try {
                const res = await fetch(controller.exportSubscribersUrl())
