...
def _generate_value(schema: Dict[str, Any], definitions: Dict[str, Any]) -> Any:
    ...
    # Resolve anyOf / oneOf FIRST so Optional[T] (Pydantic 2's anyOf: [T, null])
    # picks the concrete T branch instead of falling through to the default
    # "type" handler and emitting "test" for arrays / bools / ints / enums.
