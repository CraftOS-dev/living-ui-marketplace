...
REPLACEMENTS = {
    '{{PROJECT_ID}}': 'newsletter-tool',
    '{{PROJECT_NAME}}': 'Newsletter Tool',
    '{{PROJECT_DESCRIPTION}}': 'Production newsletter platform with subscribers, drag-and-drop email builder, AI generation, templates, scheduling, analytics, and Gmail sending.',
    '{{PORT}}': frontend_port,
