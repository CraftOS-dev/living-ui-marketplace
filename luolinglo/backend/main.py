"""
Luolinglo - Language Learning Living UI Backend

FastAPI backend for the Luolinglo language learning app.
...
async def lifespan(app: FastAPI):
    ...
    start_health_checker(port=3111)
...
app = FastAPI(
    title="Luolinglo API",
    description="Backend API for Luolinglo Language Learning Living UI",
    version="1.0.0",
    lifespan=lifespan,
)
...
async def health_check():
    ...
    return {"status": "healthy", "project": "e7f8a9b0"}
