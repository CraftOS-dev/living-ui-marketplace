import type { AppState, WidgetConfig, WidgetId, WeatherData, CalendarEvent, CalendarEventCreate, CalendarEventUpdate, Task, TaskCreate, TaskUpdate, Note, NoteCreate, NoteUpdate, Contact, ContactCreate, ContactUpdate, Reminder, ReminderCreate, ReminderUpdate, DailyBriefing } from './types'
...
export class AppController {
  ...
  async updateContact(id: number, data: ContactUpdate): Promise<Contact> {
