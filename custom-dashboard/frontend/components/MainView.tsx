...
import { CalculatorFull } from './CalculatorFull'
import { ContactsFull } from './ContactsFull'
import { UnitConverterFull } from './UnitConverterFull'
import { TimerFull } from './TimerFull'
import { QRCodeFull } from './QRCodeFull'
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
      ...
      <main style={{ flex: 1, padding: 'var(--space-4)', maxWidth: 1400, margin: '0 auto', width: '100%' }}>
        ...
        {view === 'calculator' && <CalculatorFull controller={controller} />}
        {view === 'contacts' && <ContactsFull controller={controller} />}
        {view === 'converter' && <UnitConverterFull controller={controller} />}
        {view === 'timer' && <TimerFull controller={controller} />}
        {view === 'qrcode' && <QRCodeFull controller={controller} />}
      </main>
    </div>
  )
}
