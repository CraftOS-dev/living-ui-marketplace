...
import { CreateRecordDialog } from './shell/CreateRecordDialog'
import { CreateListDialog } from './shell/CreateListDialog'
import { TaskQuickAdd } from './shell/TaskQuickAdd'
...
export function MainView() {
  ...
  const [createState, setCreateState] = useState<{ type: RecordType; defaults?: Record<string, unknown> | undefined } | null>(null)
  const [taskState, setTaskState] = useState<{ open: boolean; defaults?: { recordType?: RecordType; recordId?: number; recordName?: string } | undefined }>({ open: false })
