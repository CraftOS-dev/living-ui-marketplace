"""Replace template placeholders for local dev. Revert before committing."""
...
REPLACEMENTS = {
    '{{PROJECT_ID}}': 'image-utility',
    '{{PROJECT_NAME}}': 'Image Utility',
    '{{PROJECT_DESCRIPTION}}': 'Upload an image, crop it interactively, resize, compress, or convert to PNG/JPEG/WEBP, then download the edited file.',
    '{{PORT}}': frontend_port,
