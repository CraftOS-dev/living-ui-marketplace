...
// V2: the download URL resolves to the client-side adapter (sentinel host),
// which a real navigation (window.open) can't reach. Fetch the file through the
// patched window.fetch and save it via a temporary <a download>.
      ...
      {result && result.image_id === asset.id && (
        ...
        >
          ...
          <Button
            ...
            onClick={() => void triggerDownload(ApiService.getDownloadUrl(asset.id))}
          >
            <Download size={16} />
            Download
          </Button>
