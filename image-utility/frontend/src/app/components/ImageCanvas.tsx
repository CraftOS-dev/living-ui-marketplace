...
export function ImageCanvas({
  ...
  // V2: previewUrl points at the client-side adapter (sentinel host), which
  // <img> can't reach directly. Fetch it through window.fetch (patched by the
  // adapter), then display the resulting blob; revoke the object URL on cleanup.
