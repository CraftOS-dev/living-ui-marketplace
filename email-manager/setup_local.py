...
REPLACEMENTS = {
    ...
    '{{PROJECT_NAME}}': 'Email Manager',
    '{{PROJECT_DESCRIPTION}}': 'Kanban-style Gmail inbox with customizable filter columns, unread counts, and AI-powered per-column summaries.',
    '{{PORT}}': frontend_port,
