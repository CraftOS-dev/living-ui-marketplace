...
def _generate_value(schema: Dict[str, Any], definitions: Dict[str, Any]) -> Any:
    ...
    # anyOf / oneOf must be handled BEFORE the type default, otherwise an
    # Optional[T] field (which has no top-level "type" key) falls through the
    # string branch and we send "test" for an int/bool/enum.
