...
REPLACEMENTS = {
    '{{PROJECT_ID}}': 'word-improve',
    '{{PROJECT_NAME}}': 'Word Improve',
    '{{PROJECT_DESCRIPTION}}': 'GitHub-style merge UI for prose. Paste text, get LLM variants per paragraph or sentence, pick what you like, copy the compiled result.',
    '{{PORT}}': frontend_port,
