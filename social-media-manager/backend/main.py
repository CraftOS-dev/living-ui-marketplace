...
app = FastAPI(
    ...
    description="Backend API for Social Media Manager Living UI",
    version="1.0.0",
    lifespan=lifespan,
)
...
async def health_check():
    ...
    return {"status": "healthy", "project": "social-media-manager"}
...
if __name__ == "__main__":
    import os
    import uvicorn
    uvicorn.run(app, host="0.0.0.0", port=int(os.environ.get("PORT", 3208)))
